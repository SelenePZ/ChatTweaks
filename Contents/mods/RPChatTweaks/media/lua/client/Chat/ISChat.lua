...
require "Chat/RPChatTweaks" -- RPChatTweaks
...
function ISChat:onGearButtonClick()
    ...
    RPChatTweaks.PopulateOptionsMenu(context) -- RPChatTweaks
end
...
function ISChat:onCommandEntered()
    ...
    command, commandProcessed, chatStreamName = RPChatTweaks.ProcessOutgoingMessage(command, commandProcessed, chatStreamName) -- RPChatTweaks
...
function ISChat:updateChatPrefixSettings()
    RPChatTweaks.ResetChat() -- RPChatTweaks
    ...
    for tabNumber, chatText in ipairs(self.tabs) do
        ...
        for i,msg in ipairs(chatText.chatMessages) do
            local _, line = RPChatTweaks.ProcessIncomingMessage(msg:clone(), msg:getTextWithPrefix(), true) -- RPChatTweaks
            if line ~= nil then -- RPChatTweaks
                line = line .. " <LINE> "; -- RPChatTweaks
...
ISChat.addLineInChat = function(message, tabID)
    ...
    message, line = RPChatTweaks.ProcessIncomingMessage(message, line); -- RPChatTweaks
    if line == nil then return end -- RPChatTweaks
